...
| **RECAP** | **R**econstruction of **E**lliptical **C**ontext and **A**mbiguous **P**rompts. A technique used to resolve pronouns and incomplete follow-up questions in chat history. |
